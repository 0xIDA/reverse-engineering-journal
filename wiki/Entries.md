...
One folder per target in [`entries/`](https://github.com/0xIDA/reverse-engineering-journal/tree/main/entries); status lives in each writeup's header table.

| Target | Status | Result | Source |
|---|---|---|---|
| [what-password](https://github.com/0xIDA/reverse-engineering-journal/tree/main/entries/what-password) | solved | `kr@meri$dab3st` | [crackmes.one](https://crackmes.one/crackme/6a83e2f205a9e80a90724421) |
...
| [level5](https://github.com/0xIDA/reverse-engineering-journal/tree/main/entries/level5) | solved | `1700` / `5565` → flag `Victory!` | [Lacks on crackmes.one](https://crackmes.one/user/Lacks) |
